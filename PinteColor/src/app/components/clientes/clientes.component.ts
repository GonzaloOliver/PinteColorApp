...
export class ClientesComponent implements OnInit {
  ...
  guardarCliente() {
    ...
    var nuevocliente = {
      id: this.objetoCliente.id,
      businessName: this.objetoCliente.businessName,
      firstName: this.objetoCliente.firstName,
      lastName: this.objetoCliente.lastName,
      email: this.objetoCliente.email,
      phoneNumber: this.objetoCliente.phoneNumber,
      idType: this.objetoCliente.idType,
      idNumber: this.objetoCliente.idNumber,
      birthdayDate: this.objetoCliente.birthdayDate,
      ivaCondition: this.objetoCliente.ivaCondition.value,
      address: this.objetoCliente.address,
      city: this.objetoCliente.city,
    };
    this.serviceCliente.guardarCliente(nuevocliente).subscribe(
      (response) => {
        this.listarClientes();
  ...
  modificarCliente() {
    ...
    //ESTO ES UNA GRONCHADA PERO ME DIO PAJA MODIFICAR PARA QUE TOME LA IVA CONDICION COMO STRING
    var nuevocliente = {
      id: this.objetoCliente.id,
      businessName: this.objetoCliente.businessName,
      firstName: this.objetoCliente.firstName,
    ...
    this.serviceCliente.modificarCliente(nuevocliente).subscribe(
      () => {
        this.listarClientes();
        this.showModalSuccessSave();
      },
